...
| | |
|---|---|
| [`blogschema/schema.go`](https://github.com/jryannel/sqlb/blob/main/example/blogschema/schema.go) | Four kinds of capability decision, with a comment on each that is not obvious |
